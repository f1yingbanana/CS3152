...
public class PlayerController extends AbstractController {
    ...
    public enum AngleEnum {
        ...
        /**
         * Converts the absolute angle in degrees to a compass direction.
         * 
         * @param angle the angle to convert to an AngleEnum
         * @return the direction as an AngleEnum
         */
        public static AngleEnum convertToEnum(float angle) {
            if (angle%360 == 0) {
                return EAST;
            }
    ...
    /**
     * @return the direction heading of the player.
     */
