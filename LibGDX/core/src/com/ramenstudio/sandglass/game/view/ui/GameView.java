...
public class GameView extends Table {
  ...
  public GameView(Skin skin) {
    ...
    flipCountLabel = new Label("Flips Left: 0", skin);
    add(flipCountLabel).top().left().pad(20);
  ...
  /**
   * Updates the flip counter on the screen.
   */
  public void setFlipCount(int flipsLeft) {
    flipCountLabel.setText("Flips Left: " + flipsLeft);
  }
